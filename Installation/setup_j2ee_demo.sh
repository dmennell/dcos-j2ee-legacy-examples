...
dcos security org groups grant DeptA dcos:service:marathon:marathon:services:/hello-world full
...
dcos security org groups grant DeptA dcos:mesos:master:executor:app_id:/hello-world read
dcos security org groups grant DeptA dcos:mesos:master:task:app_id:/hello-world read
dcos security org groups grant DeptA dcos:mesos:agent:framework:role:slave_public read
dcos security org groups grant DeptA dcos:mesos:agent:executor:app_id:/hello-world read
dcos security org groups grant DeptA dcos:mesos:agent:task:app_id:/hello-world read
dcos security org groups grant DeptA dcos:mesos:agent:sandbox:app_id:/hello-world read

dcos security org groups grant DeptB dcos:adminrouter:service:marathon full
dcos security org groups grant DeptB dcos:service:marathon:marathon:services:/benefits full
